...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `mens_products`(name, price, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `mens_products`");
         ...
         <tr>
            ...
            <td>
               <a href="adminMen.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
